...
from hw07_entity_types.predict_types import train_evaluate_type_prediction
import numpy as np
...
class TestEntitiesTypes(TestCase):
    ...
    def test_01_read_word_vectors(self):
        ...
        vec_file = "hw07_entity_types/unittest-toydata/word_vectors.txt"
    ...
    def test_02_read_entity_types_file(self):
        ...
        vec_file = "hw07_entity_types/unittest-toydata/word_vectors.txt"
        entities_file = "hw07_entity_types/unittest-toydata/entity_types.txt"
        m, w2id = utils.read_word2vec_file(vec_file)
        if m is None:
    ...
    def test_03_predict_evaluate(self):
        ...
        vec_file = "hw07_entity_types/unittest-toydata/word_vectors.txt"
        train_file = "hw07_entity_types/unittest-toydata/entity_types.txt"
        test_file = "hw07_entity_types/unittest-toydata/entity_types.txt"
        fail_file = "hw07_entity_types/unittest-toydata/fail.txt"
